...
Token.prototype.isIdentifier = function() {
  return this.kind === TokenKind_1.TokenKind.IDENTIFIER;
};
Token.prototype.isNumericRelationalOperator = function() {
  return (
    this.kind === TokenKind_1.TokenKind.GT ||
    this.kind === TokenKind_1.TokenKind.GE ||
    this.kind === TokenKind_1.TokenKind.LT ||
    this.kind === TokenKind_1.TokenKind.LE ||
    this.kind === TokenKind_1.TokenKind.EQ ||
    this.kind === TokenKind_1.TokenKind.NE
  );
};
...
Token.prototype.asInstanceOfToken = function() {
  return new Token(
    TokenKind_1.TokenKind.INSTANCEOF,
    this.startPos,
    this.endPos
  );
};
Token.prototype.asMatchesToken = function() {
  return new Token(TokenKind_1.TokenKind.MATCHES, this.startPos, this.endPos);
};
Token.prototype.asBetweenToken = function() {
  return new Token(TokenKind_1.TokenKind.BETWEEN, this.startPos, this.endPos);
};
